					...
					<div class="mx-3">
						<div class="mb-3">
							<label class="form-text-lavel" for="subject_cd">科目コード</label>
								<input class="form-control" name="cd" type="text"placeholder="科目コードを入力してください" value="${cd}"maxlength="3" id="subject_cd" required />
						...
						<div class="mb-3">
							...
							<input class="form-control" name="name" type="text" id="subject_name"placeholder="科目名を入力してください" value="${name}"maxlength="20" required />
						</div>
						<div class="mb-3">
